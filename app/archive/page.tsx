  ...
  return (
    <Container className="mt-8 sm:mt-14">
      <header className="max-w-3xl mb-10">
        <h1 className="text-4xl font-bold tracking-tight text-text-primary">Archive</h1>
      ...
      <div className="max-w-3xl">
        {years.map(year => (
          <section key={year} className="mb-12">
            <h2 className="text-lg font-semibold text-text-muted mb-4">{year}</h2>
            <div className="flex flex-col space-y-6 border-l border-border pl-6">
