...
export const metadata = {
  title: 'Photos',
  description: 'A curated collection of landscapes, portraits, and moments captured during my travels and daily life.',
};
      ...
      <Container className="mt-8 sm:mt-16">
        ...
        {photos.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <h2 className="text-lg font-semibold text-zinc-800 dark:text-zinc-200 mb-2">No photos yet</h2>
            <p className="text-sm text-zinc-500 dark:text-zinc-400 max-w-md">
              Photos will be added soon. Check back later to see landscapes, portraits, and other captures from my adventures.
            </p>
          </div>
        ) : (
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {photos.map((image, imageIndex) => (
              <div
                key={imageIndex}
                className="group relative aspect-[4/3] flex-none overflow-hidden rounded-xl bg-zinc-100 dark:bg-zinc-800 transition-transform duration-300 hover:scale-105"
              >
                <Image
                  src={image.src}
